      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-0 lg:px-6 ">
        <div className="relative  overflow-hidden ">
          <div className="relative  ">
            ...
            <button 
              onClick={prevSlide}
              className="absolute hidden md:block left-4 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-20 hover:bg-opacity-30 text-white md:p-3 p-1 rounded-full transition-all backdrop-blur-xs"
            >
              <ChevronLeft className="h-6 w-6" />
            </button>
            <button 
              onClick={nextSlide}
              className="absolute hidden md:block right-4 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-20 hover:bg-opacity-30 text-white md:p-3 p-1 rounded-full transition-all backdrop-blur-sm"
            >
